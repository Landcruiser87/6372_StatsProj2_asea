...
The PCA plots show some separation but not great separation. We should still be able to get decent results using multiple variable. We will use the original variables and on the PCs.
