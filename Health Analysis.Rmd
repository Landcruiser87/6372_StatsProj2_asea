...
lda_1 <- lda(Obese_Class~.,data = train)
qda_1 <- lda(Obese_Class~.,data = train)

#confusion matrix
prd<-predict(lda_1, newdata = test)$class
table(prd,test$Obese_Class)

# Overall misclassification Error rate
(101+39)/(39+466)

#ROC
ldaprd<-predict(lda_1, newdata = train)$posterior
