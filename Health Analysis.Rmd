...
# datarf <- datarf[!rowSums(datarf[c(-1:-10,-11)] > 20),] #Unemployment outlier removal
# datarf <- datarf[!rowSums(datarf[c(-1:-11)] > 50),] #Housing outlier removal
