...
pairs(data2[,c(2:8)],col=data$Obese_Class)   # personal physical conditions
pairs(data2[,c(9:14)],col=data$Obese_Class)  # education, living
pairs(data2[,c(15:21)],col=data$Obese_Class) # race, language
...
Judging from the intial scree plot, it looks as though the third Principal component carries 90% of the variation.  The main loading coefficients for PC3 were Smoking, Diabetic, Insufficient Sleep, Uninsured, Some college and Rural housing. 
...
ldadat$Obese_Class <-  as.factor(as.character(ldadat[,22])) #change it to a factor
